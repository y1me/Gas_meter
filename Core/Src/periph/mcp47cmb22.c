...
int16_t mcp47cXbXX_reset(mcp47cXbXX_params_t *, mcp47cXbXX_data_t *);
int16_t mcp47cXbXX_set_vref(mcp47cXbXX_params_t *, mcp47cXbXX_data_t *);
int16_t mcp47cXbXX_set_gain(mcp47cXbXX_params_t *, mcp47cXbXX_data_t *);
int16_t mcp47cXbXX_set_powerdown(mcp47cXbXX_params_t *, mcp47cXbXX_data_t *);
int16_t mcp47cXbXX_set_dac0(mcp47cXbXX_params_t *, mcp47cXbXX_data_t *);
int16_t mcp47cXbXX_set_dac1(mcp47cXbXX_params_t *, mcp47cXbXX_data_t *);


void MCP47CXBXX_StateMachine_Iteration(mcp47cXbXX_params_t *, mcp47cXbXX_data_t *);
...
mcp47cXbXX_data_t MCP47CXBXX_config_data;

int16_t mcp47cXbXX_reset(mcp47cXbXX_params_t *params, mcp47cXbXX_data_t *data)
{
	int16_t ret = 0;
...
int16_t mcp47cXbXX_set_vref(mcp47cXbXX_params_t *params, mcp47cXbXX_data_t *data)
{
	int16_t ret = 0;
...
int16_t mcp47cXbXX_set_gain(mcp47cXbXX_params_t *params, mcp47cXbXX_data_t *data)
{
	int16_t ret = 0;
...
int16_t mcp47cXbXX_set_powerdown(mcp47cXbXX_params_t *params, mcp47cXbXX_data_t *data)
{
	int16_t ret = 0;
...
int16_t mcp47cXbXX_set_dac0(mcp47cXbXX_params_t *params, mcp47cXbXX_data_t *data)
{
	int16_t ret = 0;
...
int16_t mcp47cXbXX_set_dac1(mcp47cXbXX_params_t *params, mcp47cXbXX_data_t *data)
{
	int16_t ret = 0;
...
{
	MCP47CXBXX_StateMachine_Iteration(mcp47cXbXX_params,&MCP47CXBXX_config_data);
}

void MCP47CXBXX_StateMachine_Iteration(mcp47cXbXX_params_t *params, mcp47cXbXX_data_t *data)
{
    ...
    for(int16_t i = 0; i < sizeof(MCP47CXBXX_stateTransMatrix)/sizeof(MCP47CXBXX_stateTransMatrix[0]); i++) {
        if(MCP47CXBXX_stateTransMatrix[i].currState == params->currState) {
            if(MCP47CXBXX_stateTransMatrix[i].event == params->event) {
            	...
            	{
            		(MCP47CXBXX_stateFunction[params->currState].func)(params,data);
            	}
            	break;
            }
        }
